...
window.MENU = {
  sections: [
    ...
    /* ============ 4. ALCOOL & SOFT ============ */
    {
      ...
      card: {
        fr: { title:"Alcool & soft", italic:"Spiritueux, softs & jus",
              desc:"Apéritifs, rhums, vodkas, gins, whiskies, digestifs, sodas, jus frais et limonade maison.",
              price:"3 € à 14,50 €" },
        en: { title:"Spirits & soft", italic:"Spirits, softs & juices",
              desc:"Aperitifs, rums, vodkas, gins, whiskies, digestifs, sodas, fresh juices and homemade lemonade.",
              price:"€3 to €14.50" }
      },
      modal: {
        fr: { title:"Alcool & soft", italic:"Apéritifs, spiritueux, digestifs et softs, au verre ou à la bouteille." },
        en: { title:"Spirits & soft drinks", italic:"Aperitifs, spirits, digestifs and soft drinks, by the glass or bottle." }
      },
      groups: [
        ...
        { t:{fr:"Soft",en:"Soft drinks"}, items:[
          {n:"Coca Cola / Zero sugar", p:"3,90 €"}, {n:"Sprite", p:"3,90 €"}, {n:"Fanta Orange", p:"3,90 €"},
          {n:"Fuze Tea Sparkling Lemon", p:"3,90 €"}, {n:"Fuze Tea Peach Hibiscus", p:"4,00 €"},
          {n:"Minute Maid", d:{fr:"Orange, Pomme, Tomate",en:"Orange, Apple, Tomato"}, p:"4,00 €"},
          {n:"Canada dry", p:"3,90 €"}, {n:"Schweppes", d:{fr:"Tonic, agrume",en:"Tonic, citrus"}, p:"3,90 €"},
          {n:"Schweppes premium", d:{fr:"Ginger beer",en:"Ginger beer"}, p:"4,00 €"},
          {n:"Red bull", p:"5,00 €"}, {n:"Bru pétillante 50cl", p:"5,00 €"}, {n:"Bru pétillante 25cl", p:"3,00 €"},
          {n:"Bru plate 50cl", p:"5,00 €"}, {n:"Bru plate 25cl", p:"3,00 €"},
          {n:"Jus frais", d:{fr:"Créole, fraise, framboise, orange, citron",en:"Creole, strawberry, raspberry, orange, lemon"}, p:"5,50 €"},
          {n:"Thé glacé maison", d:{fr:"Saison estivale",en:"Summer season"}, p:"6,00 €"},
          {n:"Limonade maison", d:{fr:"",en:"Homemade lemonade"}, p:"5,50 €"}
        ]}
      ]
    },

    /* ============ 5. CAFÉ / BOISSONS CHAUDES ============ */
    {
      key: "cafe",
